...
(function(h) {
        ...
        if (c === k || c === i)
          (j = l[i]),
            ...
            j && j._bAttrSrc
              ...
              : q ? (j._setter || (j._setter = R(j.mData)), j._setter(d, n)) : (d[i] = n);
        i++;
      };
    if (f)
      for (; f; ) {
  ...
  function ka(a) {
    ...
    if (a.scrollBarVis !== v && a.scrollBarVis !== k) (a.scrollBarVis = v), Y(a);
      ...
      J(function(a, b) {
        a.innerHTML =
          '<div class="dataTables_sizing" style="height:0;overflow:hidden;">' + B[b] + '</div>';
        a.style.width = z[b];
      }, v);
      u &&
        J(function(a, b) {
  ...
  function x(a) {
    return null === a
      ? '0px'
      : 'number' == typeof a ? (0 > a ? '0px' : a + 'px') : a.match(/\d$/) ? a + 'px' : a;
  }
  function V(a) {
    var b,
      c,
  ...
  var m = function(a) {
    ...
    Rb = function(a, b, c) {
      return M(a)
        ? !0
        : !(M(a) || 'string' === typeof a) ? null : Za(a.replace(Aa, ''), b, c) ? !0 : null;
    },
    G = function(a, b, c) {
      var d = [],
        e = 0,
  ...
  r.registerPlural = s = function(a, b, c) {
    ...
    r.register(b, function() {
      ...
      return a === this
        ? this
        : a instanceof r ? (a.length ? (h.isArray(a[0]) ? new r(a.context, a[0]) : a[0]) : k) : a;
    });
  };
  p('tables()', function(a) {
    var b;
