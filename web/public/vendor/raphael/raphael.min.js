      ...
      (i = [r(2)]),
        (n = function(t) {
            ...
            for (var r = [], i = 0, n = t.length; n - 2 * !e > i; i += 2) {
              ...
              e
                ? i
                  ...
                  : (a[0] = { x: +t[n - 2], y: +t[n - 1] })
                : n - 4 == i ? (a[3] = a[2]) : i || (a[0] = { x: +t[i], y: +t[i + 1] }),
                r.push([
                  'C',
          ...
          function d(t, r, i) {
            ...
            for (
              var n, a, s, o, l, h, u, c, f, d, g = i ? 0 : [], x = 0, v = t.length;
              v > x;
              x++
            ) {
              var y = t[x];
          ...
          (e.findDotsAtSegment = function(t, e, r, i, n, a, s, o, l) {
            ...
            (e.isPointInsidePath = function(t, r, i) {
              var n = e.pathBBox(t);
              return (
                e.isPointInsideBBox(n, r, i) && d(t, [['M', r, i], ['H', n.x2 + 10]], 1) % 2 == 1
              );
            }),
            ...
            (function(t) {
              ...
              (t.add = function(t, e, r, i, n, a) {
                var s = [[], [], []],
                  ...
                  f;
                for (
                  t && t instanceof g && (l = [[t.a, t.c, t.e], [t.b, t.d, t.f], [0, 0, 1]]), h = 0;
                  3 > h;
                  h++
                )
                  for (u = 0; 3 > u; u++) {
            ...
            Be = function(t, r) {
              return function(i, n, a) {
                ...
                return (
                  ...
                  (f = t
                    ? p
                    : r ? c : e.findDotsAtSegment(s, o, l[0], l[1], l[2], l[3], l[4], l[5], 1)),
                ...
                if ('path' == i.type) {
                  ...
                  if (
                    ...
                    t._g.doc.getElementById(S)
                      ? g[S]++
                      : (o.defs.appendChild(
                          x(x('path'), { 'stroke-linecap': 'round', d: d[v], id: S })
                        ),
                        (g[S] = 1));
                  ...
                  if (a[e](d)) {
                    ...
                    switch (((u[d] = g), d)) {
                      ...
                      case 'fill':
                        ...
                        z[e]('opacity') &&
                          x(l, { 'fill-opacity': z.opacity > 1 ? z.opacity / 100 : z.opacity });
                      case 'stroke':
                        (z = t.getRGB(g)),
                          l.setAttribute(d, z.hex),
                          'stroke' == d &&
                            z[e]('opacity') &&
                            x(l, { 'stroke-opacity': z.opacity > 1 ? z.opacity / 100 : z.opacity }),
                          'stroke' == d &&
                            i._.arrows &&
                            ('startString' in i._.arrows && _(i, i._.arrows.startString),
                            'endString' in i._.arrows && _(i, i._.arrows.endString, 1));
            ...
            var e = 'hasOwnProperty',
              ...
              C = function(t, e, r, i, n, a) {
                ...
                if (((f.visibility = 'hidden'), e && r)) {
                  if (
                    ((c.coordsize = l(v) + p + l(y)), (f.rotation = a * (0 > e * r ? -1 : 1)), a)
                  ) {
                    var m = B(a, i, n);
                    (i = m.dx), (n = m.dy);
                  }
